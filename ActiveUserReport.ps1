...
$BackupCSV = "\\techutil01\c$\CSV\Active_Organization_User_List_$($dateFormat).csv"
$AccountingCSV = "\\nas01\Quickbooks\Accounting\Accounts Payables Internal Procedures\PO Workflow\Weekly AD Lists\ActiveUserReport_$($dateFormat).csv"
$Rows = @()
$table = @()
$NoManager = @()
$NoTitle = @()
...
$table | Export-CSV $BackupCSV
$table | Export-CSV $AccountingCSV
